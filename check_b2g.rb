...
OptionParser.new do |opt|
        opt.on('-w WARNING', '--warning=WARNING', 'Days since backup complete warning level') { |o| options[:warning] = o }
        opt.on('-c CRITICAL', '--critical=CRITICAL', 'Days since backup completed critical level') { |o| options[:critical] = o }
end.parse!
